export class ConvertText {
    public concertCsvToJson(csvText: string){
        ...
        // doesn't return an empty object literal since it'll be out-of-bounds
        for (var i = 1; i < lines.length - 1; i++) {
            ...
            // object based on a string, so in essence it can be reused for other objects in the
            // program where the JSON object becomes a different type.
